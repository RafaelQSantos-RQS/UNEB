...
void remover_do_fim(T_Lista *lista) {
    ...
    // Caso lista vazia: Exibe a mensagem de alerta e n�o efetua nenhum opera��o
    if (chkListaVazia(lista)) {
        printf("Lista vazia !! Nada a remover...\n");
        return;
    }

    // Caso Lista unit�ria: Lista com apenas um elemento
...
void remover_pelo_indice(T_Lista *lista, int indice) {
    ...
    // Caso Geral: Percorre at� o n� anterior
